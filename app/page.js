...
export default function Home() {
  ...
  slug: "gibraltar",
  image:
  "https://images.unsplash.com/photo-1667391272465-6e250d3f762f?q=80&w=1200&auto=format&fit=crop",
  description:
  ...
  const features = [
    {
      ...
      description: "Up-to-date visa guides and residency requirements.",
      icon: "🌍",
    },
    {
      title: "Taxes Made Simple",
      description: "Compare taxes, social contributions and savings.",
      icon: "💶",
    },
    {
      title: "Cost of Living",
      description: "Real living expenses for Europe's top cities.",
      icon: "🏠",
    },
    {
      title: "Healthcare",
      description: "Find the best healthcare systems and options.",
      icon: "❤️",
    },
    {
      title: "Banking & Finance",
      description: "Open accounts, transfer money and manage finances.",
      icon: "🏦",
    },
    {
      title: "Community Support",
      description: "Connect with experts and expats abroad.",
      icon: "🤝",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "We currently cover Spain, Portugal, Italy and Greece, with more countries coming soon.",
    },
    {
      question: "Is Relocate2Day free to use?",
      answer:
        "Yes — our core tools are free. We also offer a premium plan with deeper guides, tax calculators and expert support.",
    },
    {
      question: "Can Relocate2Day help me with visa applications?",
      answer:
        "We provide up-to-date guides on visa requirements and processes, but we are not a legal service. We recommend consulting a local immigration lawyer for your specific situation.",
    },
    {
      question: "How accurate is the tax information?",
      answer:
        "Our tax guides are regularly updated, but tax laws change frequently. Always verify with a local tax advisor before making financial decisions.",
    },
  ];
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-20">
          ...
          <div className="mx-auto mt-16 max-w-5xl rounded-[36px] bg-[#081B57]/95 p-8 shadow-[0_20px_80px_rgba(8,27,87,0.35)] backdrop-blur-xl">
            <div className="text-center">
              ...
              <p className="mt-3 text-gray-300">Answer a few questions and get personalized recommendations.</p>
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-500">
              Explore the best countries for your new life abroad.
            </p>
          </div>
      ...
      <section id="features" className="bg-[#f8f7ff] px-6 py-28">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-gray-500">
              All the tools and guides you need to make your move with confidence.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="rounded-[28px] bg-white p-8 shadow-lg transition hover:shadow-xl"
              >
